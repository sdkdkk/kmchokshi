    ...
    <main id="content">
      ...
      <section className="pb-8 pt-10">
        <div className="container border-bottom pb-8 pb-lg-8">
          ...
          <div className="d-flex flex-wrap client-logo-02 justify-content-center">
            <Link href="#" className="d-block item" data-animate="fadeIn">
      ...
      <section className="pb-sm-8">
        <div className="container container-xxl">
          ...
          <div className="row align-items-center flex-lg-row-reverse no-gutters">
            <div
            ...
            <div className="col-md-6 parralax-images" data-animate="fadeInLeft">
              <div className="row">
      ...
      <section className="pt-8 pb-10 border-bottom">
        <div className="container">
          <div
            ...
            data-slick-options='{"slidesToShow": 5,"infinite":true,"autoplay":false,"dots":false,"arrows":false,"responsive":[{"breakpoint": 1367,"settings": {"slidesToShow":5}},{"breakpoint": 992,"settings": {"slidesToShow":4}},{"breakpoint": 768,"settings": {"slidesToShow": 3}},{"breakpoint": 576,"settings": {"slidesToShow": 2}}]}'>
            <div className="box">
